      ...
      child: Column(
        children: <Widget>[
          TextField(
            ...
            decoration: InputDecoration.collapsed(hintText: 'Card Holder Name',
          ...
          TextField(
            ...
            keyboardType: TextInputType.numberWithOptions(),
            buildCounter: AppConfig.buildCounter(),
            decoration: InputDecoration.collapsed(hintText: 'Card Number',
                hintStyle: TextStyle(color: Colors.green,fontFamily: AppConfig.roboto),
                border: InputBorder.none),
          ),
          AppConfig.divider(),
                ...
                child: Column(
                  children: <Widget>[
                    TextField(
                      ...
                      keyboardType: TextInputType.numberWithOptions(),
                      buildCounter: AppConfig.buildCounter(),
                      decoration: InputDecoration.collapsed(hintText: 'CCV',
                          hintStyle: TextStyle(color: Colors.green,fontFamily: AppConfig.roboto),
                          border: InputBorder.none),
                    ),
                    AppConfig.divider(),
